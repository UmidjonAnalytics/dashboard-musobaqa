...
export const uz = {
  ...
  upload: {
    ...
    fileHintExcel: "Ruxsat etilgan: .xlsx, .xlsm, .xls -- eng ko'pi 50 MB",
    fileHintPowerbi: "Ruxsat etilgan: .pbix -- eng ko'pi 50 MB",
  ...
  uploadError: {
    ...
    fileTooBig: "Fayl juda katta (eng ko'pi 50 MB).",
  ...
  phase: {
    ...
    after: "Musobaqa yakunlandi. G'oliblar e'lon qilindi!",
  ...
  works: {
    ...
    empty: "Hozircha ish yo'q.",
    count: "ta ish",
    open: "Batafsil",
    download: "Faylni yuklab olish",
    votingSoon: "Ovoz berish 11-sentabrda boshlanadi.",
  ...
  vote: {
    title: "Ovoz berish",
    subtitle: "Har bir ishni uchta mezon bo'yicha 1 dan 5 gacha baholang.",
    design: "Dizayn",
    diagrams: "Diagrammalardan foydalanish",
    problem: "Muammoni yechish",
    suggestion: "Taklifingiz",
    suggestionHint: "Kamida 20 ta belgi. Bu maydon majburiy.",
    suggestionCount: "belgi",
    submit: "Ovoz berish",
    submitting: "Yuborilmoqda...",
    voted: "Ovoz berildi",
    notVoted: "Ovoz berilmagan",
    ownWork: "Bu sizning ishingiz",
    thanks: "Ovozingiz qabul qilindi. Rahmat!",
    yourScore: "Sizning bahoyingiz",
    remaining: "ta ish qoldi",
    allDone: "Barcha ishlarga ovoz berdingiz. Rahmat!",
    listNote: "Ishlar sizga tasodifiy tartibda ko'rsatilyapti.",
    loginFirst: "Ovoz berish uchun Telegram orqali kiring.",
    notVotingPhase: "Hozir ovoz berish bosqichi emas.",
  },

  voteError: {
    tooShort: "Taklif kamida 20 ta belgidan iborat bo'lishi kerak.",
    alreadyVoted: "Siz bu ishga allaqachon ovoz bergansiz.",
    ownWork: "O'z ishingizga ovoz bera olmaysiz.",
    notVotingPhase: "Hozir ovoz berish bosqichi emas.",
    badScores: "Har bir mezonni 1 dan 5 gacha baholang.",
    generic: "Xatolik yuz berdi. Qaytadan urinib ko'ring.",
  },

  results: {
    title: "Natijalar",
    subtitle: "Ballar ovoz berish davomida yangilanib boradi.",
    rank: "O'rin",
    work: "Ish",
    score: "Ball",
    votes: "Ovozlar",
    noVotes: "Ovoz yo'q",
    empty: "Hozircha natija yo'q.",
    countNote: "Ovozlar soni ballning yonida ko'rsatilgan.",
  },

  platform: {
    livePreview: "Jonli ko'rish",
    liveNote: "Bu hisobot Power BI xizmatidan olingan. Uni shu yerda ochib ko'rishingiz mumkin.",
    openInNewTab: "Yangi oynada ochish",
    noScreenshot: "Power BI hisoboti",
  },

  embed: {
    label: "Power BI embed kodi",
    hint: "Power BI xizmatida hisobotni oching: File -> Embed report -> Publish to web (public). Ko'chirilgan kodni shu yerga joylashtiring.",
    placeholder: "<iframe title=... src=\"https://app.powerbi.com/view?r=...\"></iframe>",
    accepted: "Embed havolasi qabul qilindi.",
    invalid: "Bu Power BI havolasiga o'xshamaydi. Faqat powerbi.com havolalari qabul qilinadi.",
    required: "Power BI uchun embed kodi majburiy.",
    imagesOptional: "Power BI uchun rasm ixtiyoriy -- embed asosiy ko'rinish bo'ladi.",
  },

  winner: {
    title: "G'oliblar",
    subtitle: "Musobaqa yakunlandi. Ovoz berish natijalari bo'yicha g'oliblar:",
    badge: "G'OLIB",
    score: "O'rtacha ball",
    votes: "ta ovoz asosida",
    viewWork: "Ishni ko'rish",
    none: "G'olib aniqlanmadi -- hech kimga ovoz berilmagan.",
